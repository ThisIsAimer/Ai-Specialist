...
const DoctorAi = () => {
    ...
    return (
        <section className=" h-[calc(100vh-60px)] flex flex-col justify-center my-10">
            <header>
                <h1 className=" text-center font-semibold text-4xl my-10">Chat with DoctorAI</h1>
            </header>
            ...
            <form onSubmit={handleSubmit} className="flex mx-4 gap-4 items-center my-4">
                <input type="text"
                    value={input}
                    onChange={(e) => setInput(e.target.value)}
                    placeholder="Type your message..."
                    className="w-full flex-1 px-4 py-2 border border-gray-300 bg-gray-300/50 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 transition-all duration-200"
                    disabled={loading}
                />
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="p-2 w-10 h-10 flex justify-center items-center rounded-full bg-blue-500 hover:bg-blue-600 text-white disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
